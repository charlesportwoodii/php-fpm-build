...
ifeq ($(shell if [[ "$(TESTVERSION)" -lt "84" ]]; then echo 0; else echo 1; fi;), 0)
PHP84_APK_DEPENDS=$(PHP84_APK_DEPENDS) --depends "libpsl"
PHP84_DEB_DEPENDS=$(PHP84_APK_DEPENDS) --depends "libpsl"
endif
