...
REDISEXTVERSION?=6.1.0
IGBINARYVERISON?=3.2.16
...
PHP74_APK_DEPENDS=--depends "libedit" --depends "libgpg-error" --depends "libgcrypt" --depends "oniguruma" --depends "libwebp" --depends "libxpm" --depends "libffi" --depends "libpsl"
PHP74_DEB_DEPENDS=--depends "$(LIBONIG_DEBIAN)" --depends "libedit2" --depends "libgcrypt20" --depends "libgpg-error0" --depends "$(LIBWEBP_DEBIAN)" --depends "libxpm4" --depends "$(LIBCURL_DEBIAN)" --depends "$(LIBFFI_DEBIAN) > 3.1" --depends "libpsl"
